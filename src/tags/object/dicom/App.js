...
class DicomApp extends PureComponent {
  constructor(props) {
    super(props);
    this.files = [];
    this.folder = null;
        ...
        this.setState(
          {
            ...
            textMessage:
              "The selected folder does not contains any DICOMDIR file.",
          },
          () => {
...
*/
  ...
  render() {
    ...
    console.log(this.dicomViewersRefs)
    ...
    return (
      <div>
        ...
        <AppBar className={classes.appBar} position="static" elevation={0}>
          {/*<button onClick={this.printMeasure}>Print</button>*/}
...
*/}
        ...
        <Dialog open={visibleZippedFileDlg} onClose={this.hideZippedFileDlg}>
          <DialogTitle>
            {
              "This is a zipped file, would you import into sandbox file system?"
            }
          </DialogTitle>
          <DialogActions>
